...
5. Anyone can open the public History URL to browse past days (after the first backup commits).
...
4. Keep the dashboard tab open — slate fills; history commits land in this repo and show on the History page.
